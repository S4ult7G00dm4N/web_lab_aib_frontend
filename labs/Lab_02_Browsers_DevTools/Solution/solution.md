...
| `Remote Address`  | Ip(либо домен):port хоста.                                                                                                                                                                       |
...
<details>
  ...
  - Фрагмент данных, отправленный сервером и хранящийся на компьютере пользователя. В cookie находится информация о вас. Например, логин и пароль, местоположение, языковые настройки, сведения о товарах в корзине интернет-магазина.Используются для большего понимания потенциальных рекламных предложений.
